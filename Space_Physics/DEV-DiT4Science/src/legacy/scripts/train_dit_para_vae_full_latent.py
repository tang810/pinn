...
from dit4science.utils.config import instantiate_from_config
...
def main(args):
    ...
    # Setup upsample path (scale 128 * 128 -> 256*256)
    ...
    if rank == 0:
        ...
        experiment_dir = f"{args.results_dir}/{experiment_index:03d}-{model_string_name}-channel_idx{args.predchannel}"  # Create an experiment folder
    ...
    dataset = TurbDataset(dataProp=prop, dataDir=args.data_path, gaussian_norm=False, channel_idx=args.predchannel)
...
if __name__ == "__main__":
    ...
    vae_ckpt_cond = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'weights', "cond_all_epoch=152-step=167840.ckpt")
    vae_ckpt_res = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'weights', "res_all_epoch=109-step=120669.ckpt")

    # Default args here will train DiT-XL/2 with the hyperparameters we used in our paper (except training iters).
    parser = argparse.ArgumentParser()
    parser.add_argument("--data-path", type=str, required=True)
    parser.add_argument("--predchannel", type=int, default=-1)  # the channel to predict: 0-pressure, 1-Ux, 2-Uy, -1-all channel
...
# Train DiT
# torchrun --nnodes=1 --nproc_per_node=2 scripts/train_dit_para.py --data-path=/home/chunyang/projects/ai4science/DDPM4Science/data/train_6k/

# torchrun --nnodes=1 --nproc_per_node=2 scripts/train_dit_para.py --data-path=/home/chunyang/projects/ai4science/DDPM4Science/data/data/train/reg/
# CUDA_VISIBLE_DEVICES=1,2
# torchrun --nnodes=1 --nproc_per_node=2 scripts/train_dit_para.py --data-path=/home/chunyang/projects/ai4science/DDPM4Science/data/train_6k/ --predchannel=0


# torchrun --nnodes=1 --nproc_per_node=2 scripts/train_dit_para_vae.py --data-path=/home/chunyang/projects/ai4science/DDPM4Science/data/test/ --predchannel=0
