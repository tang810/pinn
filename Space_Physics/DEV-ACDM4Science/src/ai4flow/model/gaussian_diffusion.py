...
class GaussianDiffusion(nn.Module):
    def __init__(
        ...
        # auto-normalization of test [0, 1] -> [-1, 1] - can turn off by setting it to be False
    ...
    def p_sample_loop(self, shape, return_all_timesteps=False):
        ...
        for t in tqdm(reversed(range(0, self.num_timesteps)), desc='sampling loop time step', total=self.num_timesteps):
            self_cond = self.model.self_condition.to(device)
    ...
    def sample(self, batch_size=16, return_all_timesteps=False):
        ...
        return sample_fn((batch_size, channels, image_size_h, image_size_w), return_all_timesteps=return_all_timesteps)

    # q(Xt|X0) = N(Xt;sqr(alphas_cumprod*X0, (1-alphas_cumprod)*I))
    ...
    def p_losses(self, x_start, t, noise=None):
        ...
        x_self_cond = self.self_condition
        # predict and take gradient step
        # eps-theta ~  (sqr(alphas)*X0 + sqr(1-alphas)*eps, t) ~ (Xt, t)
    ...
    def forward(self, img, *args, **kwargs):
        # print("### in diffuser, self_condition", self.self_condition)
