...
from .model_encoder import EncoderModelSkip, DecoderModelSkip
from .model_latent_transformer import LatentModelTransformerEnc, LatentModelTransformerDec, LatentModelTransformer, LatentModelTransformerMGN, LatentModelTransformerMGNParamEmb
from .model_diffusion import DiffusionModel
from .model_diffusion_blocks import Unet
from .params import DataParams, TrainingParams, LossParams, ModelParamsEncoder, ModelParamsDecoder, ModelParamsLatent

from .model_dfpnet import DfpNet
from .model_resnet import DilatedResNet
from .model_refiner import PDERefiner
...
class PredictionModel(nn.Module):
    ...
    def forward(self, data:torch.Tensor, simParameters:torch.Tensor, useLatent:bool=True) -> torch.Tensor:
        ...
        # DIRECT PREDICTION OF NEXT FRAME WITH DIFFERENT ARCHITECTURES
            ...
            if isinstance(self.modelDecoder, Unet) or isinstance(self.modelDecoder, DilatedResNet):
