...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", type=str, default="/home/chunyang/projects/ai4science/ACDM4Science/data/v2d")
    ...
    logger = Logger("ACDM_1extra_randsample", addNumber=True)
