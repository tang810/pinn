...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", type=str, default="/home/chunyang/projects/ai4science/ACDM4Science/data/foil_slice_processed")
    ...
    logger = Logger("ACDM_foilslice", addNumber=True)
