...
import alpha.config2
from alpha.config2 import Config
from alpha.const import BASE64_FORMAT
from alpha.llm import LLM
from alpha.tools.metagpt_text_to_image import oas3_metagpt_text_to_image
from alpha.tools.openai_text_to_image import oas3_openai_text_to_image
from alpha.utils.s3 import S3


async def text_to_image(text, size_type: str = "512x512", config: Config = alpha.config2.config):
    """Text to image
