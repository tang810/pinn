...
class PysicsInformedNeuralNetwork:
    ...
    def neural_net_equations(self, x, y):
        ...
        # NS
        eq1 = u_x + v_y 
        eq2 = (u*u_x + v*u_y) + p_x - (1.0/self.Re)*(u_xx + u_yy)
        eq3 = (u*v_x + v*v_y) + p_y - (1.0/self.Re)*(v_xx + v_yy) - ((self.Ri)*t)    
        eq4 = (u*t_x + v*t_y) - (1.0/self.Pe)*(t_xx + t_yy) 
    ...
    def evaluate(self, x, y, u, v, t):
        ...
        plt.savefig('result_plot_ev.png')
        plt.show()
        plt.close()
