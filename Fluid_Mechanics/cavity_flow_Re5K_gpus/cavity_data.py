...
class DataLoader(Dataset):
    def __init__(self, path=None, N_f=20000, N_b=1000):
        ...
        self.pts_bc = None
        #self.loading_boundary_data()
        #self.loading_training_data()
    ...
    def loading_training_data(self):
        ...
        #    raise 
        #self.x_train_f = xye_sorted[:, 0:1]
        #self.y_train_f = xye_sorted[:, 1:2]
        self.x_train_f = xye[:, 0:1]
        self.y_train_f = xye[:, 1:2]
        return self.x_train_f, self.y_train_f
    ...
    def __len__(self):
        return self.x_train_f.shape[0]

    def __getitem__(self, idx):
        return self.x_train_f[idx], self.y_train_f[idx]
