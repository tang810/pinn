"""
Notebook-friendly eval file for airfoil_force_pinn.

Online Jupyter usage:
1. Upload trained_model_airfoil_force.pt as a public asset.
2. Upload data.mat as a public asset.
3. Fill MODEL_HASH and DATA_HASH, then run this whole file/cell.

This file loads the PINN model, evaluates 3D airfoil force displacement (u,v,w),
...
MODEL_HASH = "3f2977f66e934f34be13d171f80995ab"
DATA_FILENAME = "data.mat"

DATA_PATH = os.path.expanduser(f"~/public/Resource/{DATA_HASH}")
MODEL_PATH = os.path.expanduser(f"~/public/Resource/{MODEL_HASH}/trained_model_airfoil_force.pt")
...
class AirfoilForcePredictor:
    ...
    def predict(self, x, y, z):
        with torch.no_grad():
            ...
            out = self.net(torch.cat([xx, yy, zz], dim=1))
